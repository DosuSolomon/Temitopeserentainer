...
import { X, Music, User, Youtube, Instagram, Facebook, Twitter, Share2, MessageCircle, Heart, Globe } from 'lucide-react';
    ...
    <>
      ...
      <div className="fixed left-0 top-0 h-screen w-80 bg-black/80 backdrop-blur-md z-50 transform transition-transform duration-300 ease-in-out translate-x-0 shadow-2xl border-r border-white/20 drop-shadow-2xl">
        ...
        <div className="p-4 overflow-y-auto h-[calc(100%-5rem)] text-white">
          ...
          {/* Song Categories */}
          <div className="mb-6">
            <div className="text-xs font-medium uppercase text-white/70 mb-3 tracking-wider px-1 drop-shadow-md">
              Song Categories
            </div>
          ...
          {/* Leave a Tip */}
          <div className="mt-auto pt-14 pb-6 border-t border-white/10 relative bottom-10 md:bottom-2">
            <Button
